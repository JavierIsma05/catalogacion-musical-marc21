...
function CanvasClass() {
  ...
  this.TransformIncipitToPAEC = function (context) {
    ...
    // Notificar al adapter, si existe un callback definido
    if (typeof context.onAfterTransform === "function") {
      try {
        context.onAfterTransform({
          paec: paec, // PAE completo
          pae031p: var031p, // PAE específico para 031 $p
          clave031g: var031g, // 031 $g
          armadura031n: var031n, // 031 $n
          compas031o: var031o, // 031 $o
          transposition: transposition
        });
      } catch (e) {
        console.warn("Error en onAfterTransform de incipit:", e);
      }
    }
  };
  /*ENDREGION*/
